                    ...
                    <form class="space-y-6" wire:submit.prevent="register" enctype="multipart/form-data">
                        ...
                        <div id="register-step-1" class="space-y-6">
                            ...
                            <div class="form-control">
                                ...
                                <p class="text-[11px] text-base-content/60 mt-1.5 leading-relaxed">
                                    NIK diperlukan hanya untuk mencocokkan identitas pemesan saat verifikasi kedatangan
                                    di
                                    lapangan.
                                </p>
                                @error('nik')
                            ...
                            <div class="form-control">
                                ...
                                <p class="text-[11px] text-base-content/60 mt-1.5 leading-relaxed">
                                    Nomor WhatsApp digunakan untuk mengirimkan informasi seputar pemesanan lapangan
                                    Anda,
                            ...
                            <div class="form-control my-5">
                                ...
                                <div class="relative group/input">
                                    ...
                                    <div class="absolute right-4 top-2">
                                        <label
                                            class="swap text-base-content/30 hover:text-base-content transition-colors">
