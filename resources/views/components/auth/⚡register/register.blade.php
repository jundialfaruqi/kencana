                        ...
                        <div class="form-control">
                            ...
                            <div class="relative group/input">
                                <input :type="showConfirmPassword ? 'text' : 'password'"
                                    ...
                                    class="input input-bordered focus:input-info bg-base-200/50 w-full pr-12 italic placeholder:text-base-content/50 @error('password_confirmation') input-warning @enderror" />
                                <div class="absolute right-4 top-2">
                                    <label class="swap text-base-content/30 hover:text-info transition-colors">
