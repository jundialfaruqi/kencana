<div data-theme="chaotictoast">
    @if ($showPopup)
        <div
            class="fixed bottom-18 sm:bottom-25 left-4 right-4 sm:max-w-md sm:mx-auto z-50 p-4 sm:p-4 bg-base-300 text-base-content text-start flex items-center justify-between rounded-xl shadow-xl text-[11px] md:text-sm gap-2">
