                ...
                <div class="w-full bg-white rounded-2xl border-2 border-base-200 shadow-lg flex flex-col sm:flex-row relative overflow-hidden detail-ticket-mask [--cut-pos:14.25rem] sm:[--cut-pos:10.75rem]"
                    ...
                    <div class="flex-1 p-4 sm:p-6 flex flex-col justify-between min-w-0">
                        ...
                        <div class="flex flex-row justify-between items-center mb-2 sm:mb-4 gap-2">
                            <!-- Status Badge -->
                            <div
                                class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-[10px] sm:text-xs font-black uppercase tracking-wider {{ ($detail['status'] ?? '') === 'dipesan' ? 'bg-info/10 text-info' : (($detail['status'] ?? '') === 'dibatalkan' ? 'bg-error/10 text-error' : 'bg-success/10 text-success') }}">
                        ...
                        <div class="grid grid-cols-2 gap-y-3 gap-x-3 sm:gap-y-4 sm:gap-x-4">
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-1.5 sm:gap-2 text-slate-700">
                                    ...
                                    <span
                                        class="text-xs sm:text-sm font-medium leading-none">{{ $tglFmt ?? ($tgl ?? '-') }}</span>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-1.5 sm:gap-2 text-slate-700">
                                    ...
                                    <span class="text-xs sm:text-sm font-medium leading-none">{{ $mulai ?? '-' }} -
                                        {{ $selesai ?? '-' }}</span>
                                </div>
                            </div>
                            ...
                            <div class="col-span-2 grid grid-cols-3 gap-2 sm:gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-1.5 sm:gap-2 text-slate-700">
                                        ...
                                        <span
                                            class="text-[10px] sm:text-sm font-medium leading-none">{{ data_get($detail, 'pemesan.jumlah_pemain') ?? '-' }}</span>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-1.5 sm:gap-2 text-slate-700">
                                        ...
                                        <span
                                            class="text-[10px] sm:text-sm font-medium capitalize leading-none">{{ strtolower(data_get($detail, 'pemesan.kategori') ?? '-') }}</span>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-1.5 sm:gap-2 text-slate-700">
                                        ...
                                        <span
                                            class="text-[10px] sm:text-sm font-medium capitalize leading-none">{{ strtolower($jenisAlias ?: '-') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                @if (!empty(data_get($detail, 'keterangan')))
                    <div class="mt-4 rounded-2xl border-2 border-base-200 bg-base-100 shadow-sm p-4">
                        <div class="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="2" stroke="currentColor" class="w-5 h-5 text-warning">
                                <path stroke-linecap="round" stroke-linejoin="round"
