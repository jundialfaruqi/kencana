<footer class="bg-base-300 text-base-content w-full mt-auto">
    ...
    <div class="px-6 md:px-10 pt-16 pb-12 max-w-7xl mx-auto flex flex-col lg:flex-row justify-between gap-12 lg:gap-20">
        ...
        <div class="flex flex-col gap-6 lg:max-w-sm">
            ...
            <p class="text-sm opacity-70 leading-relaxed">
                Kencana Arena adalah pusat olahraga dan rekreasi terpadu di Pekanbaru, menyediakan fasilitas lapangan
                berkualitas untuk menunjang gaya hidup sehat Anda.
            </p>

            <!-- Ikon Sosial Media -->
            <div class="flex gap-5 items-center mt-2">
                <a href="#" aria-label="Facebook"
                    class="hover:text-blue-500 transition-colors opacity-80 hover:opacity-100">
                ...
                <a href="#" aria-label="Instagram"
                    class="hover:text-pink-500 transition-colors opacity-80 hover:opacity-100">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"
                        class="fill-current">
                        <path
                ...
                <a href="#" aria-label="YouTube"
                    class="hover:text-red-500 transition-colors opacity-80 hover:opacity-100">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"
                        class="fill-current">
                        <path
    ...
    <div class="border-t border-base-content/10">
        <div
            class="px-6 md:px-10 py-6 pb-26 md:pb-6 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
