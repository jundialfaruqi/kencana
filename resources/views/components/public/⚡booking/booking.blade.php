<div class="mt-4 sm:mt-8" id="booking-root" data-step="{{ $currentStep }}" x-data="{ step: @entangle('currentStep') }">
    <div class="w-full" x-transition>
        ...
        <div class="mb-8 px-2 flex items-center gap-4">
            ...
            <div wire:loading wire:target="finalizeBooking" class="fixed inset-0 z-60 bg-base-100/80 backdrop-blur-sm">
                                ...
                                <ul class="space-y-1">
                                    @foreach ($group['items'] ?? [] as $item)
                                        <li class="flex items-start gap-2">
                                            <span
                                                class="flex-none mt-1.5 w-1.5 h-1.5 rounded-full bg-base-content/70"></span>
                                            <span
