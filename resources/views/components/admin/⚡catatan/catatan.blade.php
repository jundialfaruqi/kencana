<div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
        <div class="flex items-center gap-2">
            <a wire:navigate href="{{ route('catatan-create') }}" class="btn btn-secondary btn-sm shadow">
                Buat Catatan
            </a>
        </div>
            ...
            @else
                <div class="overflow-x-auto">
                    <table class="table">
                        ...
                        <tbody>
                            @php
                                $groupedCatatans = collect($catatans)->groupBy(function ($item) {
                                    return data_get($item, 'nama_lapangan') ?? 'Lainnya';
                                });
                            @endphp

                            @forelse ($groupedCatatans as $arenaName => $subItems)
