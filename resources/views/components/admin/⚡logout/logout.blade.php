<div>
    <button type="button" onclick="logout_modal_profile.showModal()"
        class="btn btn-circle btn-info btn-sm hover:bg-primary text-white transition-all" title="Logout">
    ...
    <dialog id="logout_modal_profile" class="modal modal-bottom sm:modal-middle">
        <div class="modal-box">
