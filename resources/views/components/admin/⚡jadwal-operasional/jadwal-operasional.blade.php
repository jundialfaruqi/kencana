<div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
        <div class="flex items-center gap-2">
            <a wire:navigate href="/jadwal-operasional-create" class="btn btn-secondary btn-sm uppercase font-bold">
                Buat Jadwal Baru
            </a>
        </div>
            ...
            @else
                <div class="overflow-x-auto">
                    <table class="table">
                        ...
                        <tbody>
                            @php
                                $groupedJadwal = collect($jadwal)->groupBy(function ($item) {
                                    return data_get($item, 'lapangan.nama_lapangan') ?? 'Lainnya';
                                });
                            @endphp

                            @forelse ($groupedJadwal as $arenaName => $items)
                                ...
                                @foreach ($items as $it)
                                    <tr class="hover:bg-base-200/30 transition-colors">
                                        ...
                                        <td class="font-medium text-base-content/75">
