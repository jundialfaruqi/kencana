    ...
    <div class="card bg-base-100 border border-base-300">
        ...
        <div class="modal-box">
            <h3 class="font-bold text-lg text-primary flex items-center gap-2 mb-4">
                ...
                <span class="italic uppercase tracking-wider">Export Data User</span>
            </h3>
            
            <div class="mt-4">
                <p class="text-sm text-base-content/70 mb-3">Pilih format export yang diinginkan. (Catatan: Data sensitif seperti NIK, Email, dan No WA akan disamarkan secara otomatis demi keamanan).</p>
