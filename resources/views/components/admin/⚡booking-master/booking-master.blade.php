<div>
    ...
    <dialog id="exportModal" class="modal modal-bottom sm:modal-middle backdrop-blur-sm"
        ...
        <div class="modal-box">
            ...
            <div class="mt-4">
                <p class="text-sm text-base-content/70 mb-3">Pilih format export dan rentang tanggal booking yang
                    diinginkan.</p>
            ...
            @if ($exportMessage)
                <div class="mt-6 p-4 border rounded-xl text-center">
                    <div
                        class="w-12 h-12 bg-secondary text-white rounded-full flex items-center justify-center mx-auto mb-2 shadow-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
