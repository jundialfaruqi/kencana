<div>
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-xl font-bold">Update Jadwal Khusus</h1>
            <p class="text-sm text-base-content/60 mt-1">Perbarui jadwal tambahan/libur/event</p>
        </div>
        <div>
            ...
            <div class="card-body">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <label class="form-control w-full">
                        ...
                        <input type="text"
                            class="input text-base-content italic font-black input-bordered w-full mt-1.5"
