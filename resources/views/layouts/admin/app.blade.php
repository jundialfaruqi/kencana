        ...
        <div class="drawer-content flex flex-col h-screen overflow-hidden">
            ...
            <header class="h-16 bg-base-100 flex items-center justify-between px-6 border-b border-base-200 shrink-0">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <!-- Theme Toggle -->
                    <button id="theme-toggle" class="btn btn-circle btn-sm btn-accent hover:bg-accent hover:text-white">
                        <!-- Sun Icon -->
                ...
                <div class="h-16 flex items-center px-6 border-b border-base-200 shrink-0">
                    <div class="flex items-center gap-1 text-secondary font-bold text-2xl group">
                        ...
                        <div class="flex flex-col">
                            <span
                                class="font-black tracking-tighter uppercase text-base-content group-hover:text-base-content transition-colors leading-none">Kencana</span>
                            <span
                                class="text-[10px] font-bold tracking-widest uppercase text-base-content/50 group-hover:text-base-content/70 transition-colors leading-none">Arena</span>
                        </div>
                    </div>
                </div>
                    ...
                    <ul class="menu w-full px-4 gap-1">
                        ...
                        <li>
                            <a wire:navigate href="{{ route('dashboard') }}"
                                ...
                                <span class="text-[8px] text-base-content opacity-50 ml-7">Cek kode booking</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a wire:navigate href="{{ route('statistik-analitik') }}"
                                class="{{ request()->routeIs('statistik-analitik*') ? 'active bg-base-300 text-base-content font-medium' : '' }} flex flex-col items-start gap-0.5">
                                <div class="flex items-center gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="size-5">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <span class="text-[8px] text-base-content opacity-50 ml-7">Lihat tren dan kepadatan
                                    lapangan</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a wire:navigate href="{{ route('banner-carousel') }}"
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span>Banner Berita</span>
                                </div>
                                <span class="text-[8px] text-base-content opacity-50 ml-7">
                                    Lihat, buat, ubah, hapus, dan aktivasi
                                </span>
                            </a>
                        </li>
